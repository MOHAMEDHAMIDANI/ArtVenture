            ...
            <div class="w-full flex justify-center items-center flex-col">
                ...
                <div class="w-[250px] h-[400px] border-2 rounded border-black">
                    <div class="w-full h-[45%] flex justify-evenly items-center">
                        <svg class="cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                            viewBox="0 0 24 24">
                            <path fill="#000000"
                        ...
                        <div @click="imgInp.click()" class="w-[180px] cursor-pointer  h-[150px] rounded  overflow-hidden">
                            <img v-if="photo" src="../assets/img/c40365f91a73a13388fe776ef17ddbdd.jpg" alt=""
                                class="w-full h-full object-fit object-center">
                        </div>
                        <input ref="imgInp" type="file" class="hidden">
                        <svg class="cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                            viewBox="0 0 24 24">
                            <path fill="#000000"
                    ...
                    <div class="w-[90%] h-[55%]   mx-auto">
                        <div class="flex items items-center max-h-10 justify-between  ">
                            <h1
                                ...
                                {{ title.slice(0, 30) }}</h1>
                            <h3 v-if="price" class=" my-auto font-semibold text-sm w-14 ">$ {{ price.slice(0, 5) }}</h3>
                        </div>
                ...
                <div class="w-full mt-2 ">
                    <h3 class="text-2xl font-bold text-center mx-auto w-[50%] h-fit  underline underline-offset-2">please
                    ...
                    <div class="w-full mt-5">
                        ...
                        <div class="flex items-center flex-col justify-between ">
                            ...
                            <input required v-model="info" id="info" type="text"
                                class="border-b-2 border-black outline-none pl-1 w-[300px] bg-slate-50">
                        </div>
                        <div class="flex items-center flex-col justify-between ">
                ...
                <button @click="Register" class="w-[140px] h-10 btn mt-2">
                    <h3
