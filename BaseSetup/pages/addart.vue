<template>
    <MainLay>
        <div class="w-full h-screen flex flex-col">
            <div class="w-full flex justify-evenly items-center sm:flex-wrap">
                <div class="flex justify-center  items-center flex-col ">
                    ...
                    <div class="w-[250px] h-[400px] border-2 rounded border-black">
                        <div class="w-full h-[45%] flex justify-evenly items-center">
                            <div @click="imgInp.click()" class="w-[220px] cursor-pointer text-center h-[160px] rounded  overflow-hidden">
